...
%>
		...
		<div class="row-fluid">
			<div class="span4 offset4">
				<div class="login">
					<a class="logo custom-logo text-center" href="" title="Go to bvi_internal"> <img alt="bvi_internal"  src="<%=themeDisplay.getPathThemeImage()%>/logo.png"  > </a> 
...
<c:choose>
	...
	<c:otherwise>
		<aui:form action='<%= themeDisplay.getPathMain() + "/portal/update_password" %>' method="post" name="fm">
			...
			<div class="footer">
			<aui:button-row>
				<aui:button type="submit" cssClass="btn-block btnBgBuSm"  />
			</aui:button-row>
			</div>
		</aui:form>
	</c:otherwise>
