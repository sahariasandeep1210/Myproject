...
// whitehall changes start (allowed section if not omini admin)
...
if(request.isUserInRole("Administrator")){
	...
	identificationSections = identificationSections_new;
	miscellaneousSections = miscellaneousSections_new;
}

// whitehall changes end
