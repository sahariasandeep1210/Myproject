package com.tf.controller.seller;
...
import com.tf.seller.util.AdminUtility;
import com.tf.seller.util.MyCustomNumberEditor;
...
public class BaseController {
	...
	@Autowired
	protected LiferayServiceSeller liferayServiceSeller;
