		...
		<div class="row-fluid">
  			<div class="span3">
  				<div class="control-group">
					...
					<form:input path="name"   id="companyName"  cssClass="field" />
				</div>
  			</div>  			
  			<div class="span3">
  				<div class="control-group">
					<label class="control-label" for="alname"> Alternate Name </label>
					<form:input path="altname"   cssClass="field"  />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
					<label class="control-label" for="regNum"> Registration Number * </label>
					<form:input path="regNumber"  id="registrationNo"   cssClass="field"  />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
	  		...
	  		<div class="row-fluid">
	  			<div class="span3">
	  				<div class="control-group">
						...
						<form:input path="address.addressLine1"  id="address1" placeholder="Address Line 1*"  cssClass="field" />
					</div>
	  			</div>
	  			<div class="span3">
	  				<div class="control-group">
						<label class="control-label" for="add2"> Address Line 2 </label>
						<form:input path="address.addressLine2"	id="address2" placeholder="Address Line 2" cssClass="field"  />
					</div>
	  			</div>
	  			<div class="span3">
	  				<div class="control-group">
						<label class="control-label" for="loc"> Locality </label>
						<form:input path="address.locality"  id="locality"		placeholder="Locality" cssClass="field"  />
					</div>
	  			</div>
	  			<div class="span3">
	  				<div class="control-group">
		  	...
		  	<div class="row-fluid">
	  			...
	  			<div class="span3">
	  				<div class="control-group">
						...
						<form:input path="address.postalCode" 	id="postalCode" placeholder="Postal Code*"  cssClass="field"  />
					</div>
	  			</div>
	  		</div>
		...
		<div class="row-fluid">
  			...
  			<div class="span3">
  				<div class="control-group">
					...
					<form:input path="website"  cssClass="field"  />
				</div>
  			</div>
  			<div class="span3">
				<div class="control-group">
  		...
  		<div class="row-fluid">
  			<div class="span3">
  				<div class="control-group">
					...
					<form:input path="directors" cssClass="field" />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
					<label class="control-label" for="shareholders"> Shareholders </label>
					<form:input path="shareholders" cssClass="field" />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
					<label class="control-label" for="customers"> Customers </label>
					<form:input path="customers" cssClass="field" />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
  		...
  		<div class="row-fluid">
  			<div class="span3">
  				<div class="control-group">
					...
					<form:input path="bustype" cssClass="field" />
				</div>
  			</div>
  			<div class="span3">
  				<div class="control-group">
					<label class="control-label" for="comRef"> Company Referance </label>
					<form:input path="companyreference" cssClass="field" id="companyreference" />
				</div>
  			</div>
  		</div>
		<div class="divider mb15"></div>
