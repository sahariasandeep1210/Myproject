...
public class SCFTradeServiceImpl implements SCFTradeService {
	...
	public List<SCFTrade> getScfTrades(Long companyID, int startIndex, int pageSize,String coloumnName,String order) {
		return scfTradeDAO.getScfTrades(companyID, startIndex, pageSize,coloumnName,order);
	}
	...
	public List<SCFTrade> getScfTradeList(String RegNum, int startIndex, int pageSize,String columnName,String order) {
		List<SCFTrade> scfTrades = scfTradeDAO.getScfTradeList(RegNum, startIndex, pageSize,columnName,order);
		return scfTrades;
	}
	...
	public List<SCFTrade> getScfTradeListWithSearch(String searchtxt, String RegNum, int startIndex, int pageSize,String columnName,String order) {
		List<SCFTrade> scfTrades = scfTradeDAO.getScfTradeListWithSearch(searchtxt, RegNum, startIndex, pageSize,columnName,order);
		return scfTrades;
	}
	...
	public List<SCFTrade> getScfAdminTradeListWithSearch(
		...
		return scfTradeDAO.getScfAdminTradeListWithSearch(companyId, searchtxt, fromDate, toDate, value, startIndex, pageSize,columnName, order);
	}
	...
	public  List getSumOfSCFTradeProperties(String searchText,String regNumber,boolean isSeller,long invesorId){
		  return scfTradeDAO.getSumOfSCFTradeProperties(searchText,regNumber,isSeller,invesorId);
		 }
