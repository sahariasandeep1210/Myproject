        ...
        <div class="customTableContainer mb15">
			<table class="table label-value">
				...
				<tr>
					...
					<td class="text-right"><fmt:formatNumber type="number" maxFractionDigits="3" value="${trades.tradeAmount}"  pattern="#,##0.00"/> </td>
				...
				<tr>
					...
					<td class="text-right"><fmt:formatNumber type="number" maxFractionDigits="3" value=" ${trades.sellerTransFee}"  pattern="#,##0.00"/>  </td>
				...
				<tr>
					...
					<td class="text-right"><fmt:formatNumber type="number" maxFractionDigits="3" value="${trades.sellerFees}"  pattern="#,##0.00"/></td>
					<td><b>Supplier Payment Date</b></td>
					<td class="text-center"> <fmt:formatDate value="${trades.sellerPaymentDate}" pattern="dd-MM-yyyy " /></td>
				</tr>
			</table>
		</div>   
