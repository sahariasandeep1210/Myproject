...
<form:form method="post" commandName="singlehistoryModel"
		class="form-horizontal" name="singlehistoryForm" id="singlehistoryForm" autocomplete="off"> 
	...
	<div class="table-responsive">
                           ...
                           <tr>
						    <td >
						      ...
						      <h5 style="text-align:right;">
                                  <a href="#" style="color: #295780; font-weight: bold;" id="exportSingleTradeHistory"> Export</a>
                                </h5>
                             </td>
						</tr>
					</tbody>
			...
			<table class="table  tablesorter table-bordered" id="singleTradeHistoryTable">
				<colgroup>
                <col style="width: 9.09%;">
                <col style="width: 9.09%;">
                <col style="width: 9.09%;">
