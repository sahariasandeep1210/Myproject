...
<form:form method="post" commandName="tradehistoryModel"
		class="form-horizontal" name="tradehistoryForm" id="tradehistoryForm" autocomplete="off"> 
		        <input type="hidden" value="${getTradeHistoryURL}" id="getTradeHistorys" />
	...
	<div class="table-responsive">
			...
			<table class="addtextCenter" id="tradeHisTable">
				...
				<tbody>      
						<tr>
                            ...
                            <td></td>
                            <td>
                             <input type="text" name="Search" placeholder="Search With SCF CompanyName" id="search">
                            </td>
                             <td></td>
						</tr>
                           ...
                           <tr>
                                ...
                                <td></td>
                               <td></td>
                              <td><input type="button" value="Submit" id="historyReport" class="btn btn-primary" /></td>
						...
						<tr>
						    <td >
						      ...
						      <h5 style="text-align:right;">
                                  <a href="#" style="color: #295780; font-weight: bold;" id="exportTradeHistory"> Export</a>
                                </h5>
                             </td>
			...
			<table class="table  tablesorter table-bordered" id="tradeHistoryTable">
				<colgroup>
                <col style="width: 9.09%;">
                <col style="width: 9.09%;">
                <col style="width: 9.09%;">
